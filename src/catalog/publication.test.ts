...
const READY = { hasContributor: true, hasCurrentPrice: true, hasOriginalFile: true, hasPreview: true };
...
describe('publish preconditions', () => {
  ...
  it('lists every missing piece rather than just the first', () => {
    const blockers = publishBlockers({
      hasContributor: false, hasCurrentPrice: false, hasOriginalFile: false, hasPreview: false,
    });
